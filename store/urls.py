...
urlpatterns = [
    ...
    path('products/<int:id>/', views.ProductDetails.as_view()), # Dynamic URL pattern with product ID, passed as argument to view function views.product_detail. also note that id is an integer.
